...
export const rules: Rule[] = [
  ...
  },
  {
    ...
    priority: 4,
    category: '기타',
    condition: '제목이 “(경조사) 회원 … 변리사…” 형식 또는 발신자 도메인 @kpaa.or.kr + 제목에 “경조사”',
    destination: '대한변리사회 - 경조사',
    note: '김성규 변리사 모친상·김남명 변리사 부친상 등 확인된 회원 경조사 제목은 중계 발신자여도 우선 분류',
  },
  {
    id: 'R05',
    priority: 5,
    category: '기타',
    condition: '발신자 도메인 @kpaa.or.kr + 제목에 “연수”',
    destination: '대한변리사회 - 교육',
    note: 'edu@kpaa.or.kr의 의무연수·과태료 국민비서 안내 및 재발송 포함. 실제 실행 모듈은 HiworksRulesFinal',
  },
  {
    id: 'R06',
    priority: 6,
    category: '기타',
    condition: '발신자 도메인 @kpaa.or.kr + R04·R05에 해당하지 않음',
  ...
  },
  {
    ...
    priority: 7,
    category: '기타',
    condition: '제목에 “[업무전달]”·“마감리스트”·“송부의 건”이 모두 있음',
    destination: '기일관리',
    note: '날짜 범위와 공백이 달라도 동일한 마감리스트 전달 형식으로 인식',
  },
  {
    id: 'R08',
    priority: 8,
...
export const changeLog = [
  {
    ...
    detail: 'HiworksRulesFinal에 경조사·기일관리 및 ChrW 한자 범위 보존을 동기화. 컴파일·저장 후 OTM 원본 일치와 이벤트 연결 보존 확인. 기존 메일 이동 없음',
    status: '실행본 반영',
  },
  {
    date: '2026.09.15',
    title: '의무연수 안내 누락 원인 확인',
    detail: 'HiworksRules와 실제 실행 모듈 HiworksRulesFinal의 불일치 확인. 실제 실행 모듈의 단일 주소 조건을 @kpaa.or.kr 도메인 조건으로 수정·컴파일·저장하고 원본·재발송 회귀 검증 추가. 기존 메일 이동 없음',
    status: '완료',
  },
  {
    date: '2026.09.14',
    title: '김남명 변리사 부친상 경조사 분류 확인',
    detail: '“(경조사) 회원 김남명 변리사의 부친 별세”를 이름과 가족관계를 하드코딩하지 않는 회원 경조사 제목 규칙의 회귀 사례로 추가',
    status: '완료',
  },
  {
    date: '2026.09.14',
    title: '대한변리사회 발신 도메인 범위 확대',
    detail: '특정 주소 한 개가 아니라 @kpaa.or.kr로 끝나는 모든 발신자를 경조사·교육·기타 규칙에 적용',
    status: '완료',
  },
  {
    date: '2026.09.14',
    title: '마감리스트 기일관리 분류 추가',
    detail: '“[업무전달] … 마감리스트 송부의 건” 제목을 날짜 범위와 무관하게 기일관리로 우선 분류',
    status: '완료',
  },
  {
    date: '2026.09.14',
    title: '대한변리사회 경조사 제목 예외 추가',
    detail: '“(경조사) 회원 … 변리사…” 제목은 발신 주소가 달라도 대한변리사회 - 경조사로 우선 분류',
    status: '완료',
  },
  {
    date: '2026.09.10',
